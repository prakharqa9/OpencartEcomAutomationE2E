...
public class ElementUtil {
	...
	@Step("Entering value: {1} in text field using locator: {0} and waiting for element with: {2} seconds")
	...
	@Step("clicking on element using locator: {0} and waiting for element with: {1} seconds")
	public void doClick(By locator, int timeOut) {
		waitForElementVisible(locator, timeOut).click();
	}
	
	@Step("getting the text from field using locator: {0}")
	public String doGetText(By locator) {
		return getElement(locator).getText();
	}
	
	@Step("getting the attribute name: {1} using locator: {0}")
	public String doGetAttribute(By locator, String attrName) {
		return getElement(locator).getAttribute(attrName);
	}
	
	@Step("checking the state of element: {0} is displayed or not")
	...
	@Step("wait for element: {0} to be visible within {1} seconds with time interval {2}")
	 ...
	 * @return
	 */
	@Step("waiting for the locator: {0} within {1} seconds")
	...
	@Step("waiting for the url and capturing it")
